// Pure appearance/mock helpers only — ICS parsing lives in calendar-parse.js,
// which is loaded solely by the parse worker so ical.js stays out of the main bundle.
...
export const calculateInclusiveDaySpan = (start, end) => {
